...
contract Nft_MintAndUpdateNftData_Unit_Test is Unit_Test {
    ...
    function test_mintAndUpdateNftData_DeactivatesOldNft() external mintLevel2NftForAlice {
        vm.prank(admin);
        nft.mintAndUpdateNftData(alice, NFT_TOKEN_ID_0, LEVEL_3);
    ...
    function test_mintAndUpdateNftData_SetsNftDataForNewNft() external mintLevel2NftForAlice {
        vm.prank(admin);
        nft.mintAndUpdateNftData(alice, NFT_TOKEN_ID_0, LEVEL_3);
    ...
    function test_mintAndUpdateNftData_MintsNewNft() external mintLevel2NftForAlice {
        vm.prank(admin);
        nft.mintAndUpdateNftData(alice, NFT_TOKEN_ID_0, LEVEL_3);
