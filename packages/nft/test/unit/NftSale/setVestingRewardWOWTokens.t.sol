...
//         );
//         vm.prank(alice);
//         sale.setVestingRewardWOWTokens(LEVEL_2, NEW_WOW_AMOUNT);
//     }
...
//         vm.prank(admin);
//         sale.setVestingRewardWOWTokens(LEVEL_2, 0);
//     }
...
//         sale.setVestingRewardWOWTokens(LEVEL_2, NEW_WOW_AMOUNT);
//         assertEq(
//             sale.getVestingRewardWOWTokens(LEVEL_2),
//             NEW_WOW_AMOUNT,
...
//         emit LevelTokensSet(LEVEL_2, NEW_WOW_AMOUNT);
