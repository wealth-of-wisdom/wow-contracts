...
// contract NftSale_UpdateBand_Unit_Test is Nft_Unit_Test {
...
//         uint256 oldPrice = sale.getLevelPriceInUSD(LEVEL_2);
...
//         INftSale.NftData memory nftData = sale.getNftData(NFT_TOKEN_ID_1);
