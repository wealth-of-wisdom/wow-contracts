...
contract Staking_E2E_Test is StakingAssertions {
    function test_With2Users_CreateDistribution_DistributeRewards_StakeVested__Wait_UpgradeBand_Wait_ClaimRewards()
        external
        setBandLevelData
    {
        /**
         ...
         * 5. Both users wait
         * 6. Bob upgrades band to level 5
         * 7. Both users wait
        ...
        assertBalances(
            ...
            bobPostClaimingBalance + BAND_5_PRICE - bobClaimedRewards,
