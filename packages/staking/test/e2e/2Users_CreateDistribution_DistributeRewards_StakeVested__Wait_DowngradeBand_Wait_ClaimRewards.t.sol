...
contract Staking_E2E_Test is StakingAssertions {
    function test_With2Users_CreateDistribution_DistributeRewards_StakeVested__Wait_DowngradeBand_Wait_ClaimRewards()
        external
        setBandLevelData
    {
        /**
        ...
        assertBalances(
            ...
            bobPostClaimingBalance + BAND_1_PRICE - bobClaimedRewards,
