...
import { stakeStandardFlexi, initializeAndSetUp, stakeVestedFlexi, triggerSharesSync } from "./helpers/helper";
            ...
            describe("After initialization", () => {
                ...
                describe("1 hour passed", () => {
                    ...
                    test("Should not update last sync date", () => {
                        triggerSharesSync(syncDate.plus(duration));
                ...
                describe("1 Staker", () => {
                    ...
                    describe("1 Band level", () => {
                        ...
                        afterEach(() => {
                            ...
                            triggerSharesSync(monthsAfterInit[syncMonth]);
                        });
        ...
        describe("Complex cases", () => {
            describe("3 stakers, 3 bands each, 9 band levels", () => {
                ...
                afterEach(() => {
                    ...
                    triggerSharesSync(monthsAfterInit[syncMonth].plus(bandStakingDuration));
